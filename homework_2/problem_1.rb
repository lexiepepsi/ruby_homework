...
def fizzbuzz(number)
  ...
  case
    ...
    # ((Note, 15 comes before 5. Since the when statments are evaluated top-down a number such as 30, which is a multiple of all 3 numbers, will return Fizzbuzz because the first when statement will evaluate to true and get its code executed before we even get to 3 or 5 in the lines below it.))
